...
@pytest.fixture(scope="class")
def more_controls_tab(wpf_elements: WPFApplicationElements):
...
class TestCalendarElements:
    ...
    def test_select_date(self, wpf_elements: WPFApplicationElements):
        ...
        calendar = wpf_elements.more_controls_tab.calender
        calendar.select_date(_date)
        assert calendar.selected_dates[0] == _date

    def test_add_to_selection(self, wpf_elements: WPFApplicationElements):
    ...
    def test_select_range_test(self, wpf_elements: WPFApplicationElements):
    ...
    def test_add_range_to_selection_test(self, wpf_elements: WPFApplicationElements):
