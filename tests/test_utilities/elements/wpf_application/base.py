...
from tests.test_utilities.elements.wpf_application.complex_controls import ComplexControlsElements
from tests.test_utilities.elements.wpf_application.menu import MenuElements
from tests.test_utilities.elements.wpf_application.more_controls import MoreControlsElements
from tests.test_utilities.elements.wpf_application.simple_controls import SimpleControlsElements
from tests.test_utilities.elements.wpf_application.title_bar import TitleBarElements
...
def get_wpf_application_elements(main_window: Window) -> WPFApplicationElements:
