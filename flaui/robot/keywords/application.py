from flaui.robot.module.application import Application
from flaui.robot.automation.uia import UIA
...
class ApplicationKeywords:
    ...
    def attach_application_by_name(self, name, msg=None):
        ...
        """
        return self._module.action(
            Application.Action.ATTACH_APPLICATION_BY_NAME,
            Application.create_value_container(name=name, msg=msg), msg)
    ...
    def attach_application_by_pid(self, pid, msg=None):
        ...
        """
        return self._module.action(
            Application.Action.ATTACH_APPLICATION_BY_PID,
            Application.create_value_container(pid=pid, msg=msg), msg)
    ...
    def launch_application(self, application, msg=None):
        ...
        """
        return self._module.action(
            Application.Action.LAUNCH_APPLICATION,
            Application.create_value_container(name=application, msg=msg), msg)
    ...
    def launch_application_with_args(self, application, arguments, msg=None):
        ...
        """
        return self._module.action(
            Application.Action.LAUNCH_APPLICATION_WITH_ARGS,
